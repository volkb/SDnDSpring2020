...
--
-- Host: db
-- Generation Time: Apr 18, 2020 at 07:11 PM
...
INSERT INTO `clubs` (`id`, `club_name`, `description`) VALUES
(1, 'RCOS', 'This is a dev club.'),
(2, 'Chess Club', 'You play chess'),
(3, 'RPI Ambulance', 'Student run EMS'),
(4, 'Wrestling', 'Fight club!');
...
INSERT INTO `club_roster` (`club_id`, `user_id`) VALUES
(1, 3),
(2, 1),
(2, 3),
(3, 3);
...
INSERT INTO `major` (`id`, `school_id`, `label`) VALUES
(137, 6, 'Accelerated Science, Technology, and Society (Law), B.S.'),
(122, 5, 'Aeronautical Engineering'),
(11, 3, 'Applied Physics'),
(1, 1, 'Architectural Sciences'),
(2, 1, 'Architecture'),
(12, 3, 'Astronomy'),
(13, 3, 'Biochemistry and Biophysics'),
(14, 3, 'Bioinformatics and Molecular Biology'),
(15, 3, 'Biology'),
(123, 5, 'Biomedical Engineering'),
(3, 1, 'Building Science'),
(5, 2, 'Business Analytics'),
(6, 2, 'Business and Management'),
(124, 5, 'Chemical Engineering'),
(105, 3, 'Chemistry'),
(125, 5, 'Civil Engineering'),
(138, 6, 'Cognitive Science'),
(139, 6, 'Communication and Rhetoric'),
(140, 6, 'Communication, Media, and Design, B.S.'),
(106, 3, 'Computer Science'),
(126, 5, 'Computer and Systems Engineering'),
(141, 6, 'Critical Game Design'),
(127, 5, 'Decision Sciences and Engineering Systems'),
(142, 6, 'Design, Innovation, and Society'),
(143, 6, 'Economics'),
(128, 5, 'Electrical Engineering'),
(144, 6, 'Electronic Arts'),
(129, 5, 'Environmental Engineering'),
(107, 3, 'Environmental Science'),
(145, 6, 'Games and Simulation Arts and Sciences'),
(108, 3, 'Geology'),
(109, 3, 'Hydrogeology'),
(130, 5, 'Industrial and Management Engineering'),
(120, 4, 'Information Technology'),
(4, 1, 'Lighting'),
(7, 2, 'Management'),
(131, 5, 'Materials Engineering'),
(111, 3, 'Mathematics'),
(110, 3, 'Mathematics (Applied)'),
(132, 5, 'Mechanical Engineering'),
(112, 3, 'Multidisciplinary Science'),
(121, 4, 'Multidisciplinary Science'),
(146, 6, 'Music'),
(133, 5, 'Nuclear Engineering'),
(134, 5, 'Nuclear Engineering and Science'),
(147, 6, 'Philosophy'),
(113, 3, 'Physics'),
(148, 6, 'Psychological Science'),
(8, 2, 'Quantitative Finance and Risk Analytics'),
(149, 6, 'Science, Technology, and Society'),
(9, 2, 'Supply Chain Management'),
(150, 6, 'Sustainability Studies'),
(135, 5, 'Systems Engineering and Technology Management'),
(10, 2, 'Technology, Commercialization, and Entrepreneurship'),
(136, 5, 'Transportation Engineering');
...
INSERT INTO `school` (`id`, `label`, `description`) VALUES
(1, 'SCHOOL OF ARCHITECTURE', 'SCHOOL OF ARCHITECTURE'),
(2, 'LALLY SCHOOL OF MANAGEMENT', 'LALLY SCHOOL OF MANAGEMENT'),
(3, 'SCHOOL OF SCIENCE', 'SCHOOL OF SCIENCE'),
(4, 'INFORMATION TECHNOLOGY AND WEB SCIENCE', 'INFORMATION TECHNOLOGY AND WEB SCIENCE'),
(5, 'SCHOOL OF ENGINEERING', 'SCHOOL OF ENGINEERING'),
(6, 'SCHOOL OF HUMANITIES, ARTS, AND SOCIAL SCIENCES', 'SCHOOL OF HUMANITIES, ARTS, AND SOCIAL SCIENCES');
...
(1, '2779322225497712', 'jmessare46@gmail.com', 'Joseph', 'Messare', '2020-05-25', NULL, '2779322225497712.png', '<p>Tstsdf</p>\r\n<p>sdf asdf as df<strong>asdf as dfa sdf ds</strong></p>\r\n<p style=\"text-align: right;\"><strong>&nbsp;asd ds<em>a sdfd fdfd</em></strong></p>', 1, 120, 'asdfdsf', 231, 3920, 4),
(2, '1232123', 'fake@rpi.edu', 'John', 'Doe', '2018-05-01', 'Engineering', NULL, '<p>Something amazing about me</p>', 1, 122, 'Something cool', 231, 3953, 1),
(3, '3114732755212436', 'loganramos@comcast.net', 'Logan', 'Ramos', '2020-12-20', NULL, NULL, '<p><iframe src=\"https://www.youtube.com/embed/dQw4w9WgXcQ\" width=\"560\" height=\"314\" allowfullscreen=\"allowfullscreen\"></iframe></p>\r\n<p>&nbsp;</p>\r\n<p>CS and ITWS major. RPI 2021&nbsp;</p>\r\n<p><img src=\"https://images-na.ssl-images-amazon.com/images/I/41AHRu6tDSL._AC_.jpg\" alt=\"\" width=\"344\" height=\"507\" /></p>', 1, 106, 'Logan', 231, 3943, 3),
...
--
ALTER TABLE `club_roster`
    ADD CONSTRAINT `club_roster_clubs_id_fk` FOREIGN KEY (`club_id`) REFERENCES `clubs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `club_roster_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user`
    ADD CONSTRAINT `country_user_fk` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
    ADD CONSTRAINT `major_fk` FOREIGN KEY (`major_id`) REFERENCES `major` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
    ADD CONSTRAINT `school_user_fk` FOREIGN KEY (`school_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
    ADD CONSTRAINT `state_user_fk` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
COMMIT;
